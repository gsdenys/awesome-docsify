...
- [docsify-bpmnio](https://github.com/gsdenys/docsify-bpmnio) - This is a docsify plugin that can convert bpmn xml data to svg picture in your docs. [@gsdenys](https://github.com/gsdenys)
